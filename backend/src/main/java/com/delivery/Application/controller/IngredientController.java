...
import com.delivery.Application.request.IngredientCategoryRequest;
import com.delivery.Application.request.IngredientRequest;
...
public class IngredientController {
    ...
    @PutMapping("/{id}/stoke")
    public ResponseEntity<IngredientsItem> updatingIngredientStock(
